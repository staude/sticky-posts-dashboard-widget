...
The widget shows the sticky posts.
...
Dieses Plugin stellt ein Widget für das Dashbord bereit, das die Beiträge anzeigt, die die option "Oben behalten" gesetzt haben.
...
1. Install the plugin from within the Dashboard or upload the directory `sticky-posts-dashboard-widget` and all its contents to the `/wp-content/plugins/` directory
...
Select the project "WP Plugin: Sticky Posts Dashboad Widget" and report it.
...
Wähle das Projekt "WP Plugin: Sticky Posts Dashboad Widget" und melde den Fehler.
Ich möchte eine neue Funktion vorschlage

= Bitte geh auf die Seite http://bugs.staude.net und melde dich dort an. =

Wähle das Projekt "WP Plugin: Sticky Posts Dashboad Widget" und trag deinen Wunsch ein.
